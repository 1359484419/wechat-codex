...
/**
 * Scan all known skill directories for installed Codex skills.
 *
 * Locations scanned:
 * 1. ~/.codex/skills/ (each subdirectory)
 * 2. ~/.codex/plugins/cache/{plugin}/skills/ (each subdirectory)
 * 3. ~/.codex/plugins/cache/{plugin}/superpowers/skills/ (each subdirectory)
 */
